...
class WeatherService:
    ...
    async def get_current_weather(self, lat: float, lon: float, user_id: str = "system") -> Dict[str, Any]:
    ...
    async def get_forecast(self, lat: float, lon: float, user_id: str = "system") -> Dict[str, Any]:
        ...
        # Get from API
        forecast_data = await self.weather_client.get_weather_forecast(lat, lon, user_id)
